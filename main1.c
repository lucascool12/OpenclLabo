...
void convolution_3_x_3_pll(int size, int input_depth, int output_depth) {	
	...
	ocl_err(clSetKernelArg(kernel_inner_3x3, arg_num++, sizeof(cl_int), &output_depth));
					   ...
					   float *input_features, float *layer_weights, float *layer_biases, float *output_features)
{
	...
	convolution_3_x_3_pll(feature_size, input_depth, output_depth);
